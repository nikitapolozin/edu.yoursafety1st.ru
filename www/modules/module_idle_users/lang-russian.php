...
define("_MODULE_IDLE_USERS_THISWILLDEACTIVATEALLUSERSAREYOUSURE", "Это деактивирует всех пользователей, которые вернулись, соответствующие выбранным критериям! Вы уверены?");//This will deactivate all users returned matching the selected criteria! Are you sure?
