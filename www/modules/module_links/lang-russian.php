...
define("_LINKS_MODULE","Модуль ссылок");//Links Module
define("_LINKS_MAIN","Главная страница");//Main page
define("_LINKS_MANAGEMENT","Управление ссылками");//Manage Links
...
define("_LINKS_NOLINKFOUND","Ссылки не найдены");//No links were found
define("_LINKS_LINKSPAGE","Ссылки");//Links
define("_LINKS_SUCCESFULLYINSERTEDLINKENTRY","Ссылка успешно вставлена");//The link was inserted succesfully
define("_LINKS_PROBLEMINSERTINGLINKENTRY","Произошла проблема при вставке ссылки");//A problem occured while inserting the link
define("_LINKS_SUCCESFULLYUPDATEDLINKENTRY","Ссылка успешно обновлена");//The link was updated succesfully
define("_LINKS_PROBLEMUPDATINGLINKENTRY","Возникла проблема при обновлении ссылки");//A problem occured while updating the link
